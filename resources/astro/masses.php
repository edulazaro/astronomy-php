 ...
 *
 * GENERATED. Do not edit by hand: written by `php artisan astro:masas` in the Tarotian
 * application from the ASCII header of the ephemeris the JPL publishes, and the figures
 ...
 * `tierra-luna` one is the SYSTEM's, not Earth's alone: to split the two there is
